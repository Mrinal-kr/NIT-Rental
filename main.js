...
Sign.addEventListener("click", function() {
  ...
  const handleClick = (e) => {
    // Add your code here that you want to execute when the event inside this function is triggered
    console.log("Event inside handleClick triggered");
    // Assuming you meant to apply some CSS styles here
    e.target.style.display = 'block';
  };

  sign.addEventListener("click", handleClick);
});
